...
class usermodel {
	...
	function add_user($username, $password, $email, $uid = 0) {
		...
		$regip = getIP();
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member SET uid='$uid', username='$username', password='$password', email='$email', adminid='0', groupid='10', regdate='".$this->base->time."', credits='2', timeoffset='9999'");
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_status SET uid='$uid', regip='$regip', lastip='$regip', lastvisit='".$this->base->time."', lastactivity='".$this->base->time."', lastpost='0', lastsendmail='0'");
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_profile SET uid='$uid'");
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_field_forum SET uid='$uid'");
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_field_home SET uid='$uid'");
		$this->db->query("INSERT INTO ".BBS_DBTABLEPRE."member_count SET uid='$uid', extcredits1='0', extcredits2='0', extcredits3='0', extcredits4='0', extcredits5='0', extcredits6='0', extcredits7='0', extcredits8='0'");
